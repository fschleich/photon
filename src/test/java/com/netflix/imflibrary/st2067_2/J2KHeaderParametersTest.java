...
public class J2KHeaderParametersTest {
    ...
    public void testParsedMXFJ2KParametersMatchParsedCPLParameters() throws IOException {
        ...
        CompositionImageEssenceDescriptorModel image = imfCompositionPlaylist.getCompositionImageEssenceDescriptorModels().get(0); // Calls 'J2KHeaderParameters.fromDOMNode(...)
